...
> _I don't have SMTP services operational on my server at the moment so I had to
do run a few Python commands and then login to the mysql client and update my
user password field manually. Here's how I did it._
